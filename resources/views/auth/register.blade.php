                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="role" id="role-pelanggan" value="pelanggan" checked>
                                    <label class="form-check-label" for="role-pelanggan">
                                        Pelanggan
                                    </label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="role" id="role-teknisi" value="teknisi">
                                    <label class="form-check-label" for="role-teknisi">
                                        Teknisi
                                    </label>
                                </div>
